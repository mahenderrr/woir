...
<head>
	...
	<link rel="favicon" href="assets/images/woirlogo.png">
...
?>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">
					<img src="assets/images/woirlogo.png" alt="Techro HTML5 template"></a>
			</div>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="#">Mongodb</a></li>
                                              ...
                                              <li><a href="#">Python for Machine Learning</a></li>       
						</ul>
					</li>
	...
	<header id="head">
		<div class="container">
             <div class="heading-text">							
							<h1 class="animated flipInY delay1"><a href="#">Click Here To Join Our service</a></h1>
		
						</div>
            
					<div class="fluid_container">                       
                    <div class="camera_wrap camera_emboss pattern_1" id="camera_wrap_4">
                        <div data-thumb="assets/images/slides/thumbs/spark.png" data-src="assets/images/slides/spark.png">
                            <h2>We develop.</h2>
                        </div> 
                        <div data-thumb="assets/images/slides/thumbs/bigdata4.png" data-src="assets/images/slides/bigdata4.jpg">
                        </div>
                        <div data-thumb="assets/images/slides/thumbs/hadoop.png" data-src="assets/images/slides/hadoop.png">
                        </div> 
                    </div><!-- #camera_wrap_3 -->
                </div><!-- .fluid_container -->
		</div>
    ...
    <div class="row">
					<div class="col-md-3">
						<div class="grey-box-icon">
							...
							<h4>Our Sevices</h4>
							<p>We offered the services Hadoop,Spark,Cassandra,Elastic Search,Python,Message broker,Data-Science</p>
      ...
      <section class="container" align="justify">
      <div class="row">
      	<div class="col-md-8"><div class="title-box clearfix "><h2 class="title-box_primary">About Us</h2></div> 
        <p><span>WOIR was formed by three friends in 2015 keeping in vision the innovative line of products. We have opened our center in Telecom Nagar @ Hyderabad.</span></p>
        <p>WOIR Software India Pvt. Ltd. , a startup aiming for innovative line of products has focus on Big Data Analytics. We also take work related to the domain and execute them with assured quality and in time. </p><p>Also, we offer job oriented course designed by industry experts – and we are sure that those course will help in availing new opportunities to both experienced and freshers.</p>
  ...
  <div class="footerbottom">
    ...
    <div class="col-md-3 col-sm-6"> 
            ...
            <i class="fa fa-map-marker"></i>Flat No. # 105, H.No. 1-98/5/8 ,
            1st Floor, Gayathri Heights,
            Jubilee Enclave,
            HITEC-City, Hyderabad,
            Telangana, 500081
            India.
            <br>
            <i class="fa fa-phone"></i>+91-9555295300 <br>
             <i class="fa fa-envelope-o"></i> info@woir.in
              </div> 
                </div><!-- end widget --> 
    </div>
  </div>
